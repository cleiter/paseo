...
export interface WorkspaceDescriptor {
  ...
  // User-assigned label names, already normalized by the daemon. Optional like the wire field:
  // a daemon too old to know about labels is the same as a workspace with none.
  labels?: string[];
