...
export const ru: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByLabel: "Группировать по метке",
      ...
      settingOn: "Вкл",
      settingOff: "Выкл",
      labelAdd: "Пометить как «{{label}}»",
      labelRemove: "Снять метку «{{label}}»",
      labelSearchKeywords: "метка пометить снять метку",
      viewSearchKeywords: "вид виды сохранённый фильтр",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        showNamed: "Показать вид «{{name}}»",
        none: "Рабочие пространства",
        all: "Все пространства",
        filtered: "Отфильтровано",
        switcher: "Виды: {{name}}",
        switcherEdited: "Виды: {{name}} (изменено)",
        label: "Виды",
        save: "Сохранить представление…",
        saveAsNew: "Сохранить как новое представление…",
        edit: "Изменить вид…",
        delete: "Удалить вид",
        update: "Обновить «{{name}}»",
        summary: {
          includes: "Только {{names}}",
          includesAll: "Все из {{names}}",
          excludes: "Кроме {{names}}",
          projects: "проектов: {{count}}",
          hosts: "хостов: {{count}}",
          grouping: "Группировка по {{mode}}",
          everything: "Всё",
        },
        saveTitle: "Сохранить вид",
        groupingUnchanged: "Не менять",
        editNamed: "Изменить «{{name}}»…",
        editTitle: "Изменить вид",
        nameLabel: "Название",
        placeholder: "Название вида",
        submit: "Сохранить",
        errors: {
          duplicate: "Вид с таким названием уже есть.",
          empty: "Укажите название вида.",
        },
      },
      projectFilter: {
        label: "Проект",
      ...
      labelFilter: {
        label: "Метка",
        all: "Все метки",
        matchAll: "Все метки сразу",
      },
    },
    groups: {
      unlabelled: "Без меток",
    },
    pinned: {
      title: "Закреплённые",
    },
    ...
    labelTrack: {
      ...
      title: "Метки",
      accessibility: {
        filtered: "Метки — активных фильтров: {{count}}",
        neutral: "Фильтр по «{{label}}»",
        included: "Показывается только «{{label}}» — нажмите, чтобы скрыть",
        excluded: "«{{label}}» скрыт — нажмите, чтобы снять фильтр",
      },
    },
    filter: {
      hidden: "Скрыто: {{count}}",
    ...
    workspace: {
      ...
      labels: {
        ...
        failed: "Не удалось обновить метки",
        more: "ещё {{count}} меток",
        errors: {
          duplicate: "У этого рабочего пространства уже есть такая метка.",
          tooMany: "У рабочего пространства может быть не более {{count}} меток.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      ...
      add: "Новая метка",
      empty:
        "Меток пока нет. Присвойте метку рабочему пространству из его меню или добавьте её здесь.",
      usageNone: "Ни в одном рабочем пространстве",
      usageOne: "В 1 рабочем пространстве",
      usageMany: "В {{count}} рабочих пространствах",
      edit: "Изменить {{label}}",
      delete: "Удалить {{label}}",
      createTitle: "Новая метка",
      ...
      save: "Сохранить",
      saving: "Сохранение...",
      failed: "Не удалось сохранить метку",
      partial: "{{failed}} из {{total}} хостов отклонили изменение",
      renameFailed: "Не удалось переименовать метку",
      renamePartial: "{{failed}} из {{total}} хостов отклонили переименование",
      deleteTitle: "Удалить метку?",
      deleteMessage: 'Убрать "{{label}}" из всех рабочих пространств на всех хостах.',
