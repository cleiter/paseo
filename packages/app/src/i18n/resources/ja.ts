...
export const ja: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      settingOn: "オン",
      settingOff: "オフ",
      labelAdd: "{{label}} のラベルを付ける",
      labelRemove: "{{label}} のラベルを外す",
      labelSearchKeywords: "ラベル タグ ラベルを外す",
      viewSearchKeywords: "ビュー 保存 フィルター",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        showNamed: "ビュー「{{name}}」を表示",
        none: "ワークスペース",
        all: "すべてのワークスペース",
        filtered: "絞り込み中",
        switcher: "ビュー: {{name}}",
        switcherEdited: "ビュー: {{name}}（編集済み）",
        label: "ビュー",
        save: "ビューを保存…",
        saveAsNew: "新しいビューとして保存…",
        edit: "ビューを編集…",
        delete: "ビューを削除",
        update: "「{{name}}」を更新",
        summary: {
          includes: "{{names}} のみ",
          includesAll: "{{names}} のすべて",
          excludes: "{{names}} を除外",
          projects: "プロジェクト {{count}} 件",
          hosts: "ホスト {{count}} 件",
          grouping: "{{mode}} でグループ化",
          everything: "すべて",
        },
        saveTitle: "ビューを保存",
        groupingUnchanged: "変更しない",
        editNamed: "「{{name}}」を編集…",
        editTitle: "ビューを編集",
        nameLabel: "名前",
        placeholder: "ビュー名",
        submit: "保存",
        errors: {
          duplicate: "同じ名前のビューがすでにあります。",
          empty: "ビューの名前を入力してください。",
        },
      },
      projectFilter: {
        label: "プロジェクト",
    ...
    labelTrack: {
      ...
      title: "ラベル",
      accessibility: {
        filtered: "ラベル — {{count}} 件でフィルター中",
        neutral: "{{label}} で絞り込む",
        included: "{{label}} のみ表示中 — タップで非表示に切り替え",
        excluded: "{{label}} を非表示中 — タップで絞り込みを解除",
      },
    },
    filter: {
      hidden: "{{count}} 件非表示",
    ...
    workspace: {
      ...
      labels: {
        ...
        newLabel: "新しいラベル...",
        editLabels: "ラベルを編集",
        failed: "ラベルを更新できませんでした",
        more: "他 {{count}} 件のラベル",
        errors: {
          duplicate: "このワークスペースには既にそのラベルがあります。",
          tooMany: "1 つのワークスペースに付けられるラベルは最大 {{count}} 個です。",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      ...
      add: "新しいラベル",
      empty:
        "ラベルはまだありません。ワークスペースのメニューから付けるか、ここで追加してください。",
      usageNone: "どのワークスペースにも未使用",
      usageOne: "1 つのワークスペースで使用中",
      usageMany: "{{count}} 個のワークスペースで使用中",
      edit: "{{label}} を編集",
      delete: "{{label}} を削除",
      createTitle: "新しいラベル",
      editTitle: "ラベルを編集",
      ...
      save: "保存",
      saving: "保存中...",
      failed: "ラベルを保存できませんでした",
      partial: "{{total}} 台中 {{failed}} 台のホストが変更を拒否しました",
      renameFailed: "ラベル名を変更できませんでした",
      renamePartial: "{{total}} 台中 {{failed}} 台のホストが変更を拒否しました",
      deleteTitle: "ラベルを削除しますか？",
      deleteMessage: "すべてのホストのすべてのワークスペースから「{{label}}」を削除します。",
      deleteConfirm: "削除",
    },
    editor: {
      title: "エディター",
