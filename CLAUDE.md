...
| [docs/sidebar-drag.md](docs/sidebar-drag.md)                       | Sidebar drag and drop — the one flat list, slot semantics, the vendored patch, and where the testable policy lives             |
