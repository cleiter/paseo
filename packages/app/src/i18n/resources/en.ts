export const en = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      settingOn: "On",
      settingOff: "Off",
      labelAdd: "Label as {{label}}",
      labelRemove: "Remove label {{label}}",
      labelSearchKeywords: "label tag unlabel",
      viewSearchKeywords: "view views saved filter",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        label: "Views",
        showNamed: "Show view {{name}}",
        none: "Workspaces",
        all: "All workspaces",
        filtered: "Filtered",
        switcher: "Views: {{name}}",
        switcherEdited: "Views: {{name}} (edited)",
        save: "Save view…",
        ...
        summary: {
          includes: "Only {{names}}",
          includesAll: "All of {{names}}",
          excludes: "Never {{names}}",
          projects: "{{count}} projects",
          hosts: "{{count}} hosts",
          grouping: "Grouped by {{mode}}",
          everything: "Everything",
        },
        saveTitle: "Save view",
        groupingUnchanged: "Keep current",
        editNamed: "Edit “{{name}}”…",
        editTitle: "Edit view",
        nameLabel: "Name",
        ...
        submit: "Save",
        errors: {
          duplicate: "Another view already has that name.",
    ...
    labelTrack: {
      ...
      title: "Labels",
      accessibility: {
        filtered: "Labels — {{count}} filtering",
        neutral: "Filter by {{label}}",
        included: "Showing only {{label}} — tap to hide instead",
        excluded: "Hiding {{label}} — tap to stop filtering",
      },
    },
    filter: {
      hidden: "{{count}} hidden",
      outside: "Outside the filter",
      clear: "Clear",
    },
    workspace: {
      status: {
      ...
      labels: {
        ...
        more: "{{count}} more labels",
        errors: {
          duplicate: "This workspace already has that label.",
          tooMany: "A workspace can have at most {{count}} labels.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      sectionTitle: "Labels",
      add: "New label",
      empty: "No labels yet. Label a workspace from its menu, or add one here.",
      usageNone: "On no workspaces",
      usageOne: "On 1 workspace",
      usageMany: "On {{count}} workspaces",
      edit: "Edit {{label}}",
      delete: "Delete {{label}}",
      ...
      save: "Save",
      saving: "Saving...",
      failed: "Failed to save the label",
      partial: "{{failed}} of {{total}} hosts rejected the change",
      renameFailed: "Failed to rename the label",
      renamePartial: "{{failed}} of {{total}} hosts rejected the rename",
      deleteTitle: "Delete label?",
      deleteMessage: 'Remove "{{label}}" from every workspace on every host.',
