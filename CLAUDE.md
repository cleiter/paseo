...
| [docs/sidebar-drag.md](docs/sidebar-drag.md)                       | Sidebar drag and drop — the six dnd-kit invariants that have actually broken it, and where the testable policy lives           |
