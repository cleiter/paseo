...
| [docs/terminal-input-readiness.md](docs/terminal-input-readiness.md) | Why scripts are typed into a PTY, the at-prompt invariant and nonce marker, non-zsh gap |
