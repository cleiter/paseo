...
export const zhCN: TranslationResources = {
  ...
  settings: {
    ...
    project: {
      ...
      agentEnv: {
        title: "代理环境",
        info: "代理及其启动的 MCP 服务器的环境。可直接设置变量，或运行一条打印环境的命令",
        accessibility: "代理环境命令",
        empty: "尚未配置环境。代理将以守护进程的环境启动。",
        orderHint: "按顺序应用，靠后的条目优先。",
        staticTitle: "变量",
        commandTitle: "命令",
        varKeyAccessibility: "变量名",
        varValueAccessibility: "变量值",
        varValuePlaceholder: "值",
        unsupported: "此项目的 agentEnv 无法在此显示。请在 paseo.json 中编辑；保存不会更改它。",
        removeTitle: "移除该条目？",
        removeMessage: "代理将不再获得此环境。",
        actions: {
          addVariables: "添加变量",
          addCommand: "添加命令",
          addVariable: "添加变量",
        ...
        docsTooltip: "有关详细信息以及该命令可用的环境变量，请参阅文档",
      },
      scripts: {
        title: "Scripts",
