...
export const ru: TranslationResources = {
  ...
  sidebar: {
    ...
    projectGroup: {
      noGroup: "Проекты без группы",
      moveToGroup: "Переместить в группу проектов",
      moveToNewGroup: "Новая группа проектов...",
      removeFromGroup: "Убрать из группы проектов",
      rename: "Переименовать группу проектов",
      delete: "Удалить группу проектов",
      newGroupTitle: "Новая группа проектов",
      newGroupPlaceholder: "Название группы проектов",
      renameGroupTitle: "Переименовать группу проектов",
      actions: {
        menu: "Действия с группой проектов",
      },
      confirmations: {
        deleteTitle: "Удалить группу проектов?",
        deleteMessage:
          'Удалить "{{groupName}}"?\n\nНи один проект не удаляется — они вернутся в «Проекты без группы».',
      },
    },
    workspaceGroup: {
      newGroup: "Новая группа рабочих пространств...",
      noGroup: "Рабочие пространства без группы",
      moveToGroup: "Переместить в группу рабочих пространств",
      moveToNewGroup: "Новая группа рабочих пространств...",
      removeFromGroup: "Убрать из группы рабочих пространств",
      rename: "Переименовать группу рабочих пространств",
      delete: "Удалить группу рабочих пространств",
      newGroupTitle: "Новая группа рабочих пространств",
      newGroupPlaceholder: "Название группы рабочих пространств",
      renameGroupTitle: "Переименовать группу рабочих пространств",
      actions: {
        menu: "Действия с группой рабочих пространств",
      },
      confirmations: {
        deleteTitle: "Удалить группу рабочих пространств?",
        deleteMessage:
          'Удалить "{{groupName}}"?\n\nНи одно рабочее пространство не удаляется — они вернутся в «Рабочие пространства без группы».',
      },
    },
    host: {
      noHost: "Нет хоста",
