...
export const ko: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      settingOn: "켜짐",
      settingOff: "꺼짐",
      labelAdd: "{{label}} 라벨 추가",
      labelRemove: "{{label}} 라벨 제거",
      labelSearchKeywords: "라벨 태그 라벨 제거",
      viewSearchKeywords: "뷰 저장 필터",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        ...
        summary: {
          includes: "{{names}}만",
          includesAll: "{{names}} 모두",
          excludes: "{{names}} 제외",
          projects: "프로젝트 {{count}}개",
          hosts: "호스트 {{count}}개",
          grouping: "{{mode}} 기준 그룹화",
          everything: "전체",
        },
        saveTitle: "뷰 저장",
        groupingUnchanged: "유지",
        editNamed: "“{{name}}” 편집…",
        editTitle: "뷰 편집",
        nameLabel: "이름",
        placeholder: "뷰 이름",
    ...
    labelTrack: {
      ...
      title: "라벨",
      accessibility: {
        filtered: "라벨 — {{count}}개로 필터링 중",
        neutral: "{{label}}(으)로 필터링",
        included: "{{label}}만 표시 중 — 탭하면 숨김으로 전환",
        excluded: "{{label}} 숨기는 중 — 탭하면 필터 해제",
      },
    },
    filter: {
      hidden: "{{count}}개 숨김",
    ...
    workspace: {
      ...
      labels: {
        ...
        newLabel: "새 라벨...",
        editLabels: "라벨 편집",
        failed: "라벨을 업데이트하지 못했습니다",
        more: "라벨 {{count}}개 더",
        errors: {
          duplicate: "이 워크스페이스에는 이미 해당 라벨이 있습니다.",
          tooMany: "워크스페이스에는 최대 {{count}}개의 라벨을 지정할 수 있습니다.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      sectionTitle: "라벨",
      add: "새 라벨",
      empty: "아직 라벨이 없습니다. 워크스페이스 메뉴에서 지정하거나 여기서 추가하세요.",
      usageNone: "사용 중인 워크스페이스 없음",
      usageOne: "워크스페이스 1개에서 사용 중",
      usageMany: "워크스페이스 {{count}}개에서 사용 중",
      edit: "{{label}} 편집",
      delete: "{{label}} 삭제",
      createTitle: "새 라벨",
      editTitle: "라벨 편집",
      ...
      save: "저장",
      saving: "저장 중...",
      failed: "라벨을 저장하지 못했습니다",
      partial: "호스트 {{total}}개 중 {{failed}}개가 변경을 거부했습니다",
      renameFailed: "라벨 이름을 변경하지 못했습니다",
      renamePartial: "호스트 {{total}}대 중 {{failed}}대가 변경을 거부했습니다",
      deleteTitle: "라벨을 삭제할까요?",
      deleteMessage: '모든 호스트의 모든 워크스페이스에서 "{{label}}"을(를) 제거합니다.',
      deleteConfirm: "삭제",
    },
    editor: {
      title: "편집기",
