...
export const zhCN: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      settingOff: "关",
      labelAdd: "添加标签 {{label}}",
      labelRemove: "移除标签 {{label}}",
      labelSearchKeywords: "标签 添加标签 移除标签",
      viewSearchKeywords: "视图 保存 筛选",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    ...
    labelTrack: {
      ...
      title: "标签",
      accessibility: {
        filtered: "标签 — 正在按 {{count}} 个筛选",
        neutral: "按 {{label}} 筛选",
        included: "仅显示 {{label}} — 点按改为隐藏",
        excluded: "正在隐藏 {{label}} — 点按取消筛选",
      },
    },
    filter: {
      hidden: "已隐藏 {{count}} 个",
  ...
  settings: {
    ...
    labels: {
      sectionTitle: "标签",
      add: "新建标签",
      empty: "还没有标签。从 workspace 菜单中添加，或在这里新建。",
      usageNone: "未用于任何 workspace",
      usageOne: "用于 1 个 workspace",
      usageMany: "用于 {{count}} 个 workspace",
      edit: "编辑 {{label}}",
      delete: "删除 {{label}}",
      createTitle: "新建标签",
      editTitle: "编辑标签",
      ...
      saving: "保存中...",
      failed: "保存标签失败",
      partial: "{{total}} 台主机中有 {{failed}} 台拒绝了此更改",
      renameFailed: "重命名标签失败",
      renamePartial: "{{total}} 个主机中有 {{failed}} 个拒绝了重命名",
      deleteTitle: "删除标签？",
      deleteMessage: "从所有主机上的所有 workspace 中移除“{{label}}”。",
      deleteConfirm: "删除",
    },
    editor: {
      title: "编辑器",
