...
export const es: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      labelRemove: "Quitar la etiqueta {{label}}",
      labelSearchKeywords: "etiqueta etiquetar quitar etiqueta",
      viewSearchKeywords: "vista vistas guardada filtro",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        showNamed: "Mostrar vista {{name}}",
        none: "Espacios de trabajo",
        all: "Todos los espacios",
        filtered: "Filtrado",
        switcher: "Vistas: {{name}}",
        switcherEdited: "Vistas: {{name}} (editada)",
        label: "Vistas",
        save: "Guardar vista…",
        saveAsNew: "Guardar como vista nueva…",
        edit: "Editar vista…",
        ...
        groupingUnchanged: "Mantener actual",
        ...
        submit: "Guardar",
        errors: {
          duplicate: "Otra vista ya tiene ese nombre.",
          empty: "Ponle un nombre a la vista.",
        },
      },
      projectFilter: {
        label: "Proyecto",
    ...
    labelTrack: {
      ...
      accessibility: {
        ...
        included: "Mostrando solo {{label}}: toca para ocultarla",
        excluded: "Ocultando {{label}}: toca para dejar de filtrar",
      },
    },
    filter: {
      hidden: "{{count}} ocultos",
      outside: "Fuera del filtro",
      clear: "Limpiar",
    },
    workspace: {
      status: {
      ...
      labels: {
        ...
        failed: "No se pudieron actualizar las etiquetas",
        more: "{{count}} etiquetas más",
        errors: {
          duplicate: "Este espacio de trabajo ya tiene esa etiqueta.",
          tooMany: "Un espacio de trabajo puede tener como máximo {{count}} etiquetas.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      ...
      add: "Nueva etiqueta",
      empty: "Aún no hay etiquetas. Etiqueta un espacio de trabajo desde su menú o añade una aquí.",
      usageNone: "En ningún espacio de trabajo",
      usageOne: "En 1 espacio de trabajo",
      usageMany: "En {{count}} espacios de trabajo",
      edit: "Editar {{label}}",
      ...
      save: "Guardar",
      saving: "Guardando...",
      failed: "No se pudo guardar la etiqueta",
      partial: "{{failed}} de {{total}} hosts rechazaron el cambio",
      renameFailed: "No se pudo renombrar la etiqueta",
      renamePartial: "{{failed}} de {{total}} hosts rechazaron el cambio de nombre",
      deleteTitle: "¿Eliminar la etiqueta?",
      deleteMessage: 'Quitar "{{label}}" de todos los espacios de trabajo en todos los hosts.',
