...
export const ar: TranslationResources = {
  ...
  settings: {
    ...
    project: {
      ...
      agentEnv: {
        title: "بيئة الوكيل",
        info: "بيئة الوكيل وخوادم MCP التي يشغّلها. عيّن المتغيرات مباشرة، أو شغّل أمرًا يطبعها",
        accessibility: "أمر بيئة الوكيل",
        empty: "لم تُضبط أي بيئة. يبدأ الوكيل ببيئة الخفي.",
        orderHint: "تُطبَّق بالترتيب. الإدخالات اللاحقة تسود.",
        staticTitle: "المتغيرات",
        commandTitle: "أمر",
        varKeyAccessibility: "اسم المتغير",
        varValueAccessibility: "قيمة المتغير",
        varValuePlaceholder: "القيمة",
        unsupported: "لا يمكن عرض agentEnv لهذا المشروع هنا. حرّره في paseo.json — لن يغيّره الحفظ.",
        removeTitle: "إزالة الإدخال؟",
        removeMessage: "لن يحصل الوكيل على هذه البيئة بعد الآن.",
        actions: {
          addVariables: "إضافة متغيرات",
        ...
        docsTooltip: "راجع الوثائق لمزيد من التفاصيل ومتغيرات البيئة المتاحة لهذا الأمر",
      },
      scripts: {
        title: "البرامج النصية",
