...
export const ptBR: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByLabel: "Agrupar por etiqueta",
      ...
      labelAdd: "Etiquetar como {{label}}",
      labelRemove: "Remover a etiqueta {{label}}",
      labelSearchKeywords: "etiqueta etiquetar remover etiqueta",
      viewSearchKeywords: "visualização visualizações salva filtro",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        showNamed: "Mostrar visualização {{name}}",
        none: "Espaços de trabalho",
        all: "Todos os workspaces",
        filtered: "Filtrado",
        switcher: "Visualizações: {{name}}",
        switcherEdited: "Visualizações: {{name}} (editada)",
        label: "Visualizações",
        save: "Salvar visualização…",
        saveAsNew: "Salvar como nova visualização…",
        edit: "Editar visualização…",
        delete: "Excluir visualização",
        update: "Atualizar “{{name}}”",
        summary: {
          includes: "Apenas {{names}}",
          includesAll: "Todas de {{names}}",
          excludes: "Nunca {{names}}",
          projects: "{{count}} projetos",
          hosts: "{{count}} hosts",
          grouping: "Agrupado por {{mode}}",
          everything: "Tudo",
        },
        saveTitle: "Salvar visualização",
        groupingUnchanged: "Manter atual",
        editNamed: "Editar “{{name}}”…",
        editTitle: "Editar visualização",
        nameLabel: "Nome",
        placeholder: "Nome da visualização",
        submit: "Salvar",
        errors: {
          duplicate: "Outra visualização já tem esse nome.",
          empty: "Dê um nome à visualização.",
        },
      },
      projectFilter: {
        label: "Projeto",
    ...
    labelTrack: {
      ...
      title: "Etiquetas",
      accessibility: {
        filtered: "Etiquetas: {{count}} filtrando",
        neutral: "Filtrar por {{label}}",
        included: "Mostrando apenas {{label}} — toque para ocultar",
        excluded: "Ocultando {{label}} — toque para parar de filtrar",
      },
    },
    filter: {
      hidden: "{{count}} ocultos",
      outside: "Fora do filtro",
      clear: "Limpar",
    },
    workspace: {
      status: {
      ...
      labels: {
        ...
        failed: "Falha ao atualizar as etiquetas",
        more: "mais {{count}} etiquetas",
        errors: {
          duplicate: "Este workspace já tem essa etiqueta.",
          tooMany: "Um workspace pode ter no máximo {{count}} etiquetas.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      ...
      add: "Nova etiqueta",
      empty: "Ainda não há etiquetas. Etiquete um workspace pelo menu dele ou adicione uma aqui.",
      usageNone: "Em nenhum workspace",
      usageOne: "Em 1 workspace",
      usageMany: "Em {{count}} workspaces",
      edit: "Editar {{label}}",
      ...
      save: "Salvar",
      saving: "Salvando...",
      failed: "Falha ao salvar a etiqueta",
      partial: "{{failed}} de {{total}} hosts recusaram a alteração",
      renameFailed: "Falha ao renomear a etiqueta",
      renamePartial: "{{failed}} de {{total}} hosts recusaram a renomeação",
      deleteTitle: "Excluir a etiqueta?",
      deleteMessage: 'Remover "{{label}}" de todos os workspaces em todos os hosts.',
