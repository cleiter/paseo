...
export const fr: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByLabel: "Grouper par étiquette",
      ...
      labelAdd: "Étiqueter comme {{label}}",
      labelRemove: "Retirer l'étiquette {{label}}",
      labelSearchKeywords: "étiquette étiqueter retirer étiquette",
      viewSearchKeywords: "vue vues enregistrée filtre",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        showNamed: "Afficher la vue {{name}}",
        none: "Espaces de travail",
        all: "Tous les espaces",
        filtered: "Filtré",
        switcher: "Vues : {{name}}",
        switcherEdited: "Vues : {{name}} (modifiée)",
        label: "Vues",
        ...
        summary: {
          includes: "Uniquement {{names}}",
          includesAll: "Toutes : {{names}}",
          excludes: "Jamais {{names}}",
          projects: "{{count}} projets",
          hosts: "{{count}} hôtes",
          grouping: "Groupé par {{mode}}",
          everything: "Tout",
        },
        saveTitle: "Enregistrer la vue",
        groupingUnchanged: "Ne pas changer",
        ...
        submit: "Enregistrer",
        errors: {
          duplicate: "Une autre vue porte déjà ce nom.",
          empty: "Donnez un nom à la vue.",
        },
      },
      projectFilter: {
        label: "Projet",
      ...
      labelFilter: {
        ...
        matchAll: "Toutes les étiquettes",
      },
    },
    groups: {
    ...
    labelTrack: {
      ...
      title: "Étiquettes",
      accessibility: {
        filtered: "Étiquettes — {{count}} filtre actif",
        neutral: "Filtrer par {{label}}",
        included: "Affiche uniquement {{label}} — appuyez pour la masquer",
        excluded: "Masque {{label}} — appuyez pour arrêter de filtrer",
      },
    },
    filter: {
      hidden: "{{count}} masqués",
      outside: "Hors du filtre",
      clear: "Effacer",
    },
    workspace: {
      status: {
      ...
      labels: {
        ...
        failed: "Échec de la mise à jour des étiquettes",
        more: "{{count}} étiquettes de plus",
        errors: {
          duplicate: "Cet espace de travail a déjà cette étiquette.",
          tooMany: "Un espace de travail peut avoir au maximum {{count}} étiquettes.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      sectionTitle: "Étiquettes",
      add: "Nouvelle étiquette",
      empty:
        "Aucune étiquette pour l'instant. Étiquetez un espace de travail depuis son menu ou ajoutez-en une ici.",
      usageNone: "Sur aucun espace de travail",
      usageOne: "Sur 1 espace de travail",
      usageMany: "Sur {{count}} espaces de travail",
      edit: "Modifier {{label}}",
      ...
      save: "Enregistrer",
      saving: "Enregistrement...",
      failed: "Échec de l'enregistrement de l'étiquette",
      partial: "{{failed}} hôtes sur {{total}} ont refusé la modification",
      renameFailed: "Échec du renommage de l'étiquette",
      renamePartial: "{{failed}} hôtes sur {{total}} ont refusé le renommage",
      deleteTitle: "Supprimer l'étiquette?",
      deleteMessage: 'Retirer "{{label}}" de tous les espaces de travail sur tous les hôtes.',
