...
export const ar: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      groupByLabel: "تجميع حسب التسمية",
      ...
      settingOn: "تشغيل",
      settingOff: "إيقاف",
      labelAdd: "إضافة التسمية {{label}}",
      labelRemove: "إزالة التسمية {{label}}",
      labelSearchKeywords: "تسمية وسم إزالة التسمية",
      viewSearchKeywords: "عرض عروض محفوظ تصفية",
    },
  },
  composer: {
    placeholders: {
  ...
  sidebar: {
    display: {
      ...
      views: {
        ...
        all: "كل مساحات العمل",
        filtered: "مُصفّى",
        switcher: "العروض: {{name}}",
        switcherEdited: "العروض: {{name}} (مُعدّل)",
        label: "العروض",
        save: "حفظ العرض…",
        ...
        summary: {
          includes: "فقط {{names}}",
          includesAll: "كل من {{names}}",
          excludes: "باستثناء {{names}}",
          projects: "{{count}} مشاريع",
          hosts: "{{count}} مضيفين",
          grouping: "مجمّع حسب {{mode}}",
          everything: "كل شيء",
        },
        saveTitle: "حفظ العرض",
        groupingUnchanged: "دون تغيير",
        editNamed: "تحرير «{{name}}»…",
        editTitle: "تحرير العرض",
        nameLabel: "الاسم",
        placeholder: "اسم العرض",
        submit: "حفظ",
        errors: {
          duplicate: "يوجد عرض آخر بهذا الاسم.",
      ...
      labelFilter: {
        label: "التسمية",
        all: "كل التسميات",
        matchAll: "مطابقة كل التسميات",
      },
    },
    groups: {
      unlabelled: "بدون تسميات",
    },
    pinned: {
      title: "المثبتة",
    },
    ...
    labelTrack: {
      ...
      title: "التسميات",
      accessibility: {
        filtered: "التسميات — عدد عوامل التصفية: {{count}}",
        neutral: "التصفية حسب {{label}}",
        included: "عرض {{label}} فقط — اضغط للإخفاء بدلاً من ذلك",
        excluded: "إخفاء {{label}} — اضغط لإيقاف التصفية",
      },
    },
    filter: {
      hidden: "{{count}} مخفية",
      outside: "خارج عامل التصفية",
      clear: "مسح",
    },
    workspace: {
      status: {
      ...
      labels: {
        ...
        failed: "تعذر تحديث التسميات",
        more: "{{count}} تسميات أخرى",
        errors: {
          duplicate: "مساحة العمل هذه لديها تلك التسمية بالفعل.",
          tooMany: "يمكن أن تحتوي مساحة العمل على {{count}} تسميات كحد أقصى.",
        },
      },
      confirmations: {
  ...
  settings: {
    ...
    labels: {
      sectionTitle: "التسميات",
      add: "تسمية جديدة",
      empty: "لا توجد تسميات بعد. سمِّ مساحة عمل من قائمتها أو أضف واحدة هنا.",
      usageNone: "غير مستخدمة في أي مساحة عمل",
      usageOne: "في مساحة عمل واحدة",
      usageMany: "في {{count}} مساحات عمل",
      edit: "تحرير {{label}}",
      delete: "حذف {{label}}",
      createTitle: "تسمية جديدة",
      ...
      save: "حفظ",
      saving: "جارٍ الحفظ...",
      failed: "تعذر حفظ التسمية",
      partial: "رفض {{failed}} من {{total}} مضيفًا التغيير",
      renameFailed: "تعذّر إعادة تسمية التصنيف",
      renamePartial: "رفض {{failed}} من أصل {{total}} مضيفًا إعادة التسمية",
      deleteTitle: "حذف التسمية؟",
      deleteMessage: 'إزالة "{{label}}" من كل مساحة عمل على كل مضيف.',
      deleteConfirm: "حذف",
    },
    editor: {
      title: "المحرر",
